...
> 本仓库基于开源课程设计项目 [guanqr/Garbage-Classification](https://github.com/guanqr/Garbage-Classification) 整理和二次开发，保留原项目的垃圾分类训练/推理功能，并新增本地 Flask Web 演示能力。数据集、答辩 PPT、讲稿和本地测试材料不纳入公开仓库。
